...
var sector_start_a
var sector_start_b
var sector_end_a = [Vector2(15,1),Vector2(31,17)]
var sector_end_b = [Vector2(1,16),Vector2(15,1)]
...
var attack = 3
var defense = 3
var race = preload("res://Names/human.png")
var exp_points = 0
var asc = 0
var asc_stage
var asc_sickness = 0
...
func ascend_1(to):
	asc_stage = to
	get_node("SOLDIER").set_visible(0)
	to.set_visible(1)
	asc = 1
...
func sickness():
	...
	attack += 4
	defense += 3
	get_node("MONK").set_visible(1)
	asc = 2
	
func ascend_2():
	asc_stage.set_visible(0)
	if asc_stage == get_node("KNIGHT"):
		attack += 3
		defense += 5
		get_node("GUARDIAN").set_visible(1)
	elif asc_stage == get_node("MERCENARY"):
		attack += 8
		defense += 3
		get_node("HUNTER").set_visible(1)
	elif asc_stage == get_node("INNKEEPER"):
		attack += 11
		get_node("STORYTELLER").set_visible(1)
	elif asc_stage == get_node("ADEPT"):
		attack += 8
		get_node("WIZARD").set_visible(1)
	asc = 2
